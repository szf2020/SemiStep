...
- S7NetPlus автоматически разбивает большие запросы на несколько PDU (PDU independence)
...
Для работы с S7NetPlus через PUT/GET необходимо:
